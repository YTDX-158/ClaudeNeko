...
在浏览器里驱动 **Claude Code CLI** 的本地 Web 界面——带整套皮肤系统、WebGL 流体背景，还有一只**点击会冒气泡**的粒子猫猫。
...
- 🎨 **皮肤系统**：8 套主题 / 渐变 8 套 / WebGL 流体（色相·速度·漩涡·饱和·亮度·色彩数）/ 字体颜色 / 强调色 / 一键恢复默认
- 🐱 **粒子猫猫**：点击冒气泡（20 种猫咪颜文字随机），2 秒后消失
- 📋 会话管理：双击改名 / 自动命名（取首句前 15 字）/ 空会话自动清理 / 右上角实时显示当前模型
- ⚡ 流式输出（SSE 打字机效果）
